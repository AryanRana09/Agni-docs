---
title: "Quickstart"
description: "Get started integrating with Agni in minutes."
---
...
<AccordionGroup>
  <Accordion icon="copy" title="Clone your docs locally">
    During the onboarding process, you created a GitHub repository with your docs content if you didn't already have one. You can find a link to this repository in your [dashboard](https://dashboard.ravan.ai).
...
<AccordionGroup>
  <Accordion icon="github" title="Install our GitHub app">
    Install the Mintlify GitHub app from your [dashboard](https://dashboard.ravan.ai/).
...
<Note>
  **Need help?** Contact us at [hi@ravan.ai](mailto:hi@ravan.ai) or view the [API Docs](/api-reference/introduction).
</Note>
